...
- GPT-подбор нужен только для ранжирования реальных кандидатов из базы и объяснения выбора. Модель никогда не должна возвращать ткань, которой нет в базе данных.
